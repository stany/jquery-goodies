...
Go to the project's demo page to see an example of each goodie to play with.
...
h2. Testing
Go to the demo page to see the functionality tested using "QUnit":http://docs.jquery.com/QUnit and the "jquery-simulate plugin":http://github.com/eduardolundgren/jquery-simulate that lets you simulate drag-and-drop or sortable behavior.
